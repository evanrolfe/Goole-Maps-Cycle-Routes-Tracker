...
$(function(){
	$("#form").validate({
		messages : { country: 'Please select a continent and country.'}
	});
});
...
<div id='create_form' style='display: none'>
					<table cellspacing='5px'>
						...
						<td>
							<input type="checkbox" name="category_all" class="category"> All bicycles<br>
							<input type="checkbox" name="category_mountain" class="category"> Mountain bikes<br>
							<input type="checkbox" name="category_downhill" class="category"> Downhill bikes
						</td>
						</tr>
						<tr>
							<td></td>
